    ...
    <div class="container">
        ...
        <div class="user-details">
            ...
            <div>
                ...
                <i class="fa fa-edit edit-icon" onclick="window.location.href='BuyerServlet?taskType=updateEmail'"></i>
            </div>
            <div>
                <label>Contact:</label>
            ...
            <div>
                ...
                <i class="fa fa-edit edit-icon" onclick="window.location.href='BuyerServlet?taskType=updatePassword'"></i>
            </div>
            <div>
