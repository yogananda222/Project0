...
<body>
    <section class="main-container">
        ...
        <form action="RetailerServlet" method="post">
            ...
            <table>
                <tr>
                    <td><label for="brand"><b></b></label></td>
                    <td>
                        <div class="input-container">
                            <i class="fas fa-store icon"></i>
                            <input type="text" id="brand" name="brandName" placeholder="Enter the Brand Name" required>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label for="residence"><b></b></label></td>
                    <td>
                        <div class="input-container">
                            <i class="fas fa-home icon"></i>
                            <input type="text" id="residence" name="residencePlace" placeholder="Enter your city" required>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <a href="retailerLogin.jsp"><b>An Approved Retailer? Login here!</b></a>
